...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Nightmare\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Nightmare/';
  if (isLinux) dataDir = process.env.HOME + '/.nightmare/';
}
...
var bitcoindConf = {
  ...
  user: process.env.BITCOIND_USER || 'night',
  pass: process.env.BITCOIND_PASS || 'x',
